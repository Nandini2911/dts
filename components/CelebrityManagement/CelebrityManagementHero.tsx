    ...
    >
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-[780px] text-[14px] font-medium leading-[1.9] text-white/90 sm:text-[15px] md:text-[16px]">
          Connect your event, brand campaign or corporate gathering with the
          right public personalities. From talent sourcing and negotiations to
          logistics, contracts and on-ground coordination, our team manages the
          complete process for seamless celebrity appearances.
        </p>
