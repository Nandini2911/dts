          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <a
                ...
                className="relative z-10 block h-[300px] cursor-pointer overflow-hidden rounded-[22px] bg-[#0D2444] shadow-[0_18px_45px_rgba(13,36,68,0.18)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6288B9] focus-visible:ring-offset-4"
              >
                <img
                  src={project.image}
                  alt={project.title}
