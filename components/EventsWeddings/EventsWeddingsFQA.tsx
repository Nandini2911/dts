...
export default function EventWeddingFaq() {
  ...
  const faqs: FaqItem[] = [
    {
      question: "What event management services does Double Trouble Studio provide?",
      answer:
    ...
    {
      question: "Can you manage luxury weddings and premium celebrations?",
      answer:
    ...
    {
      question: "Do you help with décor, theme and production planning?",
      answer:
    ...
    {
      question: "Do you coordinate vendors for events and weddings?",
      answer:
    ...
    {
      question: "Do you manage guest hospitality and logistics?",
      answer:
    ...
    {
      question: "Can you arrange artists, celebrities and entertainment for events?",
      answer:
    ...
    {
      question: "Which cities do you provide event management services in?",
      answer:
    ...
    {
      question: "What information do you need to start planning an event?",
      answer:
    ...
    {
      question: "Why should we choose Double Trouble Studio for event and wedding management?",
      answer:
    ...
    {
      question: "How much do event management and wedding planning services cost?",
      answer:
