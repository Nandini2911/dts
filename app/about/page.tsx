...
const aboutSchema = {
  ...
  "@graph": [
...

    {
      ...
      "slogan":
        "We Build Cultural Brands That Feel Alive",
      ...
      "audience": {
        ...
        "audienceType":
          "Hospitality brands, luxury brands, restaurants, cafes, fashion labels, lifestyle companies, wedding planners, event companies, creators, influencers, corporate brands, founders and modern startups",
      },
      ...
      "employee": [
        {
          "@id":
            "https://www.dtsworld.in/about#ravish-verma",
        },
        {
          "@id":
            "https://www.dtsworld.in/about#nandini-yadav",
        },
        {
          "@id":
            "https://www.dtsworld.in/about#ritika-tiwari",
        },
        {
          "@id":
            "https://www.dtsworld.in/about#simran-salagre",
        },
        {
          "@id":
            "https://www.dtsworld.in/about#naman-gupta",
        },
        {
          "@id":
            "https://www.dtsworld.in/about#amitesh-singh",
        },
      ],
    },
...

    {
      ...
      "name":
        "About Double Trouble Studio | Creative Agency in India",
      ...
      "breadcrumb": {
        "@id":
          "https://www.dtsworld.in/about#breadcrumb",
      },

      "hasPart": [
        {
          "@id":
            "https://www.dtsworld.in/about#team",
        },
        {
          "@id":
            "https://www.dtsworld.in/about#faq",
        },
      ],
      ...
      "audience": {
        ...
        "audienceType":
          "Brands and businesses looking for branding, digital marketing, public relations, website development, SEO, guest management, event marketing, AI video production and VFX services",
      },
...

    {
      ...
      "isPartOf": {
        "@id":
          "https://www.dtsworld.in/about#webpage",
      },
      ...
      "mainEntity": [
        {
          ...
          "@id":
            "https://www.dtsworld.in/about#faq-difference",
...

        {
          ...
          "@id":
            "https://www.dtsworld.in/about#faq-brands",

          "name":
            "What kind of brands do you usually work with?",

          "acceptedAnswer": {
            "@type": "Answer",

            "@id":
              "https://www.dtsworld.in/about#faq-brands-answer",
...

        {
          ...
          "@id":
            "https://www.dtsworld.in/about#faq-philosophy",
...

        {
          ...
          "@id":
            "https://www.dtsworld.in/about#faq-strategy",

          "name":
            "Do you focus only on aesthetics or strategy as well?",
...

        {
          ...
          "@id":
            "https://www.dtsworld.in/about#faq-remote",

          "name":
            "Can Double Trouble Studio work with brands remotely?",
